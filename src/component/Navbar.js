...
import "./Navbar.css"
import img0 from "../image/Logo.png"
...
const Navbar = () => {
  return (
    <>
      ...
      <ul>
        <center><div className="testnav">
          <div>
            <img src={img0} width="500" height="100" />
          </div>

          <h2>A Marketplace Dedicated to Delighting You</h2>
          <div>
            <ul className="nav-links">
              {/* <li><Link to="/">Home</Link></li>
              <li><Link to="/bangels">Chains</Link></li>
